...
let infiniteUpdate = document.querySelector(
    '.infinite[type="checkbox"]:checked'
);
...
function upAnimateSample() {
    ...
    userGeneratedCode =
        ...
        nameField.value +
        "'" +
        " by setting animation-duration:" +
        durationField.value +
        "s, your animation-delay is: " +
        delayField.value +
        "s, and your animation-iteration-count is:" +
        iterationAttribute;
    hiddenCode.innerHTML =
        "\n" + swingCode.innerHTML + "\n" + "\n" + userGeneratedCode;
}
