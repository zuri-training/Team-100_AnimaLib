...
$(".but").click(function() {
            ...
            if (color_code == "rgb(255, 255, 255)") {
                ...
                alert($(this).css("background-color");
                        ...
                        $(".but").not(this).css("background-color", "#EDEDF2"); $(".but").not(this).css("color", "#555555");

                        $("#animatedobject").removeClass(); $("#animatedobject").addClass("result"); $("#animatedobject").addClass(animation_name); $("#action_name").val(animation_name);
                    }
                    // fade it in
            });
