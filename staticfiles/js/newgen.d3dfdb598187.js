...
$("#objectfield").change(function() {
    var value = $(this).val();
    if (value == "circle") {
        $(".outputresult .result").css("border-radius", "50%");
    } else {
...
$("#savelogo").click(function() {
    ...
    if (anim.trim() == "") {
        ...
        var url_origin = window.location.origin + "/generator/save_code/";
...
$("#download").click(function() {
    ...
    if (anim.trim() == "") {
        ...
        var url_origin = window.location.origin + "/generator/download_code/";
