...
from animaLibApp.views import profile
from .models import *
...
class UserAdminConfig(UserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal', {
         'fields': ('name', 'user_image', 'date_joined', 'last_login',)}),
    )
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'email', 'name', 'user_image', 'password1', 'password2', 'is_staff', 'is_superuser', 'is_active'), }
         ),
    )
